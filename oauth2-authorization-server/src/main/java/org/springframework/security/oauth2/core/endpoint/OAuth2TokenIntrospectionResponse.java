...
public class OAuth2TokenIntrospectionResponse {
	 ...
	 */
	public static Builder withClaims(Map<String, Object> parameters) {
		Assert.notEmpty(parameters, "parameters cannot be empty");
	...
	public static final class Builder {
		...
		public OAuth2TokenIntrospectionResponse build() {
			return new OAuth2TokenIntrospectionResponse(this.params);
		}
	}
}
