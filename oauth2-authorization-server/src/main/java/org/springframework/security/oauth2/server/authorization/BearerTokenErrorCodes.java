...
/**
 * Standard error codes defined by the OAuth 2.0 Authorization Framework: Bearer
 * Token Usage.
 *
 * @author Vedran Pavic
 * @since 5.1
 * @see <a href="https://tools.ietf.org/html/rfc6750#section-3.1" target=
 *      "_blank">RFC 6750 Section 3.1: Error Codes</a>
 */
public interface BearerTokenErrorCodes {
	 ...
	 * parameter, uses more than one method for including an access token, or is
	 * otherwise malformed.
	 */
